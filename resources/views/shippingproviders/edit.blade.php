            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Edit Shipping Provider</h5>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('shipping-providers.update', $shippingProvider->ProviderID) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('ProviderName') is-invalid @enderror" id="ProviderName" 
                                name="ProviderName" value="{{ old('ProviderName', $shippingProvider->ProviderName) }}" required maxlength="100">
                        </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('Token') is-invalid @enderror" id="Token" 
                                name="Token" value="{{ old('Token', $shippingProvider->Token) }}" required maxlength="255">
                        </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('ClientID') is-invalid @enderror" id="ClientID" 
                                name="ClientID" value="{{ old('ClientID', $shippingProvider->ClientID) }}" required maxlength="100">
                        </div>
                        
                        <div class="form-group mb-3">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="IsRecipientPays" name="IsRecipientPays" 
                                    value="1" {{ old('IsRecipientPays', $shippingProvider->IsRecipientPays) ? 'checked' : '' }}>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="number" step="0.01" min="0" class="form-control @error('ShippingCost') is-invalid @enderror" 
                                id="ShippingCost" name="ShippingCost" value="{{ old('ShippingCost', $shippingProvider->ShippingCost) }}" required>
                        </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('EstimatedDeliveryTime') is-invalid @enderror" 
                                ...
                                value="{{ old('EstimatedDeliveryTime', $shippingProvider->EstimatedDeliveryTime) }}" required maxlength="100">
                        </div>
                        
                        <div class="form-group mb-3">
                            <label for="ServiceDetails">Service Details</label>
                            <textarea class="form-control @error('ServiceDetails') is-invalid @enderror" 
                                id="ServiceDetails" name="ServiceDetails" rows="3">{{ old('ServiceDetails', $shippingProvider->ServiceDetails) }}</textarea>
                        </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control @error('DeliveryTimeByRegion') is-invalid @enderror" 
                                id="DeliveryTimeByRegion" name="DeliveryTimeByRegion" rows="3">{{ old('DeliveryTimeByRegion', $shippingProvider->DeliveryTimeByRegion) }}</textarea>
                        </div>
                        
                        <div class="form-group text-center">
                            <button type="submit" class="btn btn-primary">Update Shipping Provider</button>
                        </div>
                    </form>
                </div>
            </div>
