                    ...
                    <form action="{{ route('shipping-addresses.store') }}" method="POST">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('LocationName') is-invalid @enderror" id="LocationName" 
                                name="LocationName" value="{{ old('LocationName') }}" required maxlength="100">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control @error('Address') is-invalid @enderror" id="Address" 
                                name="Address" required maxlength="255">{{ old('Address') }}</textarea>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('Country') is-invalid @enderror" id="Country" 
                                        name="Country" value="{{ old('Country') }}" required maxlength="100">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('ZipCode') is-invalid @enderror" id="ZipCode" 
                                        name="ZipCode" value="{{ old('ZipCode') }}" required maxlength="10">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group mb-3">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="IsPickupAddress" name="IsPickupAddress" 
                                    value="1" {{ old('IsPickupAddress') ? 'checked' : '' }}>
